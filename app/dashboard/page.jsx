  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="flex items-center justify-between w-full">
        <h1 className="text-3xl font-bold mb-6 dark:text-black">Admin Account</h1>
        <div>
          <button
            type="submit"
      ...
      <div className="bg-white shadow-md mx-14 rounded-lg p-6 mb-6 flex justify-center items-center flex-col">
        <h2 className="text-xl font-semibold mb-4 text-black">Add School</h2>
        <form className='w-1/2' onSubmit={handleAddSchool}>
          <input
            type="text"
      ...
      <div className="bg-white shadow-md mx-14 rounded-lg p-6 mb-6 flex justify-center items-center flex-col">
        ...
        <form className='w-1/2' onSubmit={handleAddEvent}>
          <input
            type="text"
